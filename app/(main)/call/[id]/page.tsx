...
import { Video, VideoOff, Mic, MicOff, PhoneOff, Monitor, MessageSquare, Clock, Star } from "lucide-react"
      ...
      {isConnecting && (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Setting up secure connection with {booking.expert?.user.name}</p>
          </div>
        </div>
      )}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 relative bg-black/90 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold text-foreground">{booking.expert?.user.name}</h2>
            ...
            <Card className="absolute top-4 left-1/2 -translate-x-1/2 glass border-border/50">
              <CardContent className="py-2 px-4 flex items-center gap-3">
                ...
                <span className="font-mono text-lg font-bold">{formatTime(callDuration)}</span>
          ...
          <div className="p-4 bg-card border-t border-border/50">
            <div className="max-w-lg mx-auto flex items-center justify-center gap-4">
              ...
              <Button variant="outline" size="lg" className="rounded-full w-14 h-14 bg-transparent">
      ...
      <Dialog open={showRatingModal} onOpenChange={setShowRatingModal}>
        <DialogContent className="glass border-border/50">
          <DialogHeader>
            ...
            <DialogDescription>How was your consultation with {booking.expert?.user.name}?</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="flex gap-2">
            ...
            <Button onClick={handleSubmitRating} disabled={rating === 0} className="bg-primary hover:bg-primary/90">
              Submit Rating
            </Button>
          </DialogFooter>
        </DialogContent>
