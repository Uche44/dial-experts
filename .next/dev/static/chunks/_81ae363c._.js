...
function AuthProvider({ children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, _password, role)=>{
            setIsLoading(true);
            // Simulate API call
            await new Promise({
            ...
            let foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find({
                "AuthProvider.useCallback[login].foundUser": (u)=>u.email === email
            }["AuthProvider.useCallback[login].foundUser"]);
            if (!foundUser && role) {
                foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find({
                    "AuthProvider.useCallback[login]": (u)=>u.role === role
                }["AuthProvider.useCallback[login]"]);
            }
            if (foundUser) {
                setUser(foundUser);
    ...
    const signup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signup]": async (data)=>{
            setIsLoading(true);
            // Simulate API call
            await new Promise({
                "AuthProvider.useCallback[signup]": (resolve)=>setTimeout(resolve, 1500)
...
_s(AuthProvider, "mOb9vr4lZGLdA0phoQYZRqRmwDg=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_81ae363c._.js.map