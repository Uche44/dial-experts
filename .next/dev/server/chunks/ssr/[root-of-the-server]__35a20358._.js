...
function AuthProvider({ children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email, _password, role)=>{
        setIsLoading(true);
        // Simulate API call
        await new Promise((resolve)=>setTimeout(resolve, 1000));
        // Find mock user by email or role
        let foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === email);
        if (!foundUser && role) {
            foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.role === role);
        }
        if (foundUser) {
            setUser(foundUser);
            localStorage.setItem("dialexperts_user", JSON.stringify(foundUser));
            setIsLoading(false);
            return true;
        }
        setIsLoading(false);
    ...
    const signup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (data)=>{
        setIsLoading(true);
        // Simulate API call
        ...
        const newUser = {
            ...
            name: data.name,
            email: data.email,
            walletAddress: data.walletAddress || `${Math.random().toString(36).substring(2, 6)}...${Math.random().toString(36).substring(2, 6)}`,
            role: data.role,
            createdAt: new Date()
        };
        setUser(newUser);
        localStorage.setItem("dialexperts_user", JSON.stringify(newUser));
        setIsLoading(false);
        return true;
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__35a20358._.js.map