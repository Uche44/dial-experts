...
function SignupContent() {
    ...
    const { signup, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        if (activeTab === "user") {
            ...
            formData.append("password", expertForm.password);
        ...
        if (success) {
            toast({
                title: activeTab === "user" ? "Account created!" : "Application submitted!",
                description: activeTab === "user" ? "Welcome to DialExperts." : "Your expert application is pending review."
            });
            router.push(activeTab === "user" ? "/dashboard" : "/expert");
        }
    };
    const expertSteps = [
        {
...
//# sourceMappingURL=_0fd9e2ca._.js.map