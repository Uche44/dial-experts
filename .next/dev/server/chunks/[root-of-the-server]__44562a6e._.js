...
function generateToken(userId, walletAddress, role) {
    const payload = {
        userId,
        walletAddress,
        role
...
async function POST(request) {
    try {
        ...
        const existingWallet = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                walletAddress
            }
        });
        ...
        const existingEmail = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                email
            }
        });
        ...
        if (role === "expert") {
            ...
            // Generate JWT token
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateToken"])(newUser.id, newUser.walletAddress, newUser.role);
            // Set token in httpOnly cookie
            (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).set("auth_token", token, {
                httpOnly: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44562a6e._.js.map